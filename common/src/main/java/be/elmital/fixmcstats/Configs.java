...
public class Configs {
    public final static ArrayList<ConfigEntry> configEntries = new ArrayList<>();
    ...
    public static final ConfigEntry MISSING_SPACE_STATS_SCREEN = registerEntry(new ConfigEntry("missing-space-stats-screen-fix", Boolean.TRUE.toString(), Patch.of(80827, ModEnvironment.CLIENT), false, false));
    public static final ConfigEntry DAMAGE_DEALT_WITH_SWEEPING_FIX = registerEntry(new ConfigEntry("damage-dealt-sweeping-fix", Boolean.TRUE.toString(), Patch.of(111435, ModEnvironment.SERVER), false, false));
    public static final ConfigEntry RARE_BLOCKS_COLORS = registerEntry(new ConfigEntry("rare-blocks-colors-fix", Boolean.TRUE.toString(), Patch.of(139386, ModEnvironment.CLIENT), false, true));
    public static final ConfigEntry DISTANCE_FALLEN_ON_LANDING_FIX = registerEntry(new ConfigEntry("distance-fallen-on-landing-fix", Boolean.TRUE.toString(), Patch.of(121541, ModEnvironment.SERVER), false, false));
    ...
    public static final ConfigEntry JUMP_WHEN_CLIMBING_SCAFFOLDING_FIX = registerEntry(new ConfigEntry("jump-when-climbing-fix", Boolean.TRUE.toString(), Patch.of(211938, ModEnvironment.SERVER), false, false));
    public static final ConfigEntry ITEM_SORTING_FIX = registerEntry(new ConfigEntry("item-sorting-stats-screen-fix", Boolean.TRUE.toString(), Patch.of(213103, ModEnvironment.CLIENT), false, false));
    ...
    public static final ConfigEntry SHIELD_USED_FIX = registerEntry(new ConfigEntry("shield-used-fix", Boolean.TRUE.toString(), Patch.of(298805, ModEnvironment.SERVER), false, false));
