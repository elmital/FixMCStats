...
public class Configs {
    ...
    public static ConfigEntry CAMEL_STAT = registerEntry(new ConfigEntry("use-camel-riding-stat", Boolean.TRUE.toString(), Patch.of(148457, ModEnvironment.CLIENT), false)); // TODO SET TO SERVER AFTER TESTS
